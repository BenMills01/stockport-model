...
class ViewerAppTests(unittest.TestCase):
    ...
    def test_on_pitch_dashboard_renders(self, mock_context: object) -> None:
        mock_context.return_value = {
            ...
            "selected_profile_label": "Controller",
            "selected_profile_points": ["Influence in possession", "Connector"],
            "selected_physical_label": "Controller Midfielder",
            "selected_physical_points": ["Mobility over long phases", "Pressure retention"],
            "selected_physical_blend": [{"label": "Physical Output", "percent": 65.0}],
